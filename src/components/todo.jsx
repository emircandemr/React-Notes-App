...
function Todo({text,todo,setTodo,element}) {
  ...
  return (
    ...
    <div className={`todo relative justify-center items-center w-1/4 h-72 border-box m-4 rounded-2xl ${element.completed===true ? "bg-black" : "bg-purple-800"  } shadow-2xl z-0`}>

        <div className={`todo w-full h-full  ${element.completed===true ? "bg-white" : "bg-white"  } shadow-2xl rounded-2xl p-2 relative top-2 left-2 z-10 overflow-hidden`}>
